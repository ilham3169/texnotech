...
const Search = ({ cartItems }) => {
  ...
  const handleSearch = () => {
    fetch(
      "https://back-texnotech.onrender.com/products?search_query=" + searchText
    )
  ...
  return (
    <>
      <section className="search" style={{ width: "100%" }}>
        {/* Desktop Layout */}
        <div className="header-container c_flex desktop-header">
          ...
          >
            <img
              style={{ width: "30px", paddingTop: "3px", marginRight: "5px" }}
              src="/assets/geo.png"
              alt="geo icon"
            />
          ...
          <div className="success-order">
            ...
            <p style={{ paddingLeft: "50%", color: "green" }}>
              {successfulOrders}
            </p>
          </div>
              ...
              {cities.map((city) => (
                <div
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    backgroundColor:
                      city === selectedCity ? "#5f4dee" : "#f0f0f0",
